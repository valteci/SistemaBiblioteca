...
public class TelaExemplaresExcluidos extends BaseWindow {

    /**
     * Creates new form TelaColaboradores
     */
    public TelaExemplaresExcluidos() {
        super(null);
        initComponents();
        jPanel = jPanelFundo;
    ...
    private void initComponents() {
        ...
        bt_cadastrarColaborador.setText("<html><p style = \"text-align: center;\">EXCLUIR UM<br>EXEMPLAR</p></html>");
        ...
        jLabel4.setText("EXEMPLARES EXCLUIDOS");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 240, 210, 30));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "TÍTULO", "ÁREA DO DIREITO", "ISBN", "PREÇO", "MOTIVO DA EXCLUSÃO"
            }
        ) {
        ...
        jLabel1.setText("EXEMPLARES - EXCLUIR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExemplaresExcluidos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaExemplaresExcluidos().setVisible(true);
            }
        });
    }
