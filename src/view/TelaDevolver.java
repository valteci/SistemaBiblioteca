 ...
 * @author junio
 */
public class TelaDevolver extends BaseWindow {
    ...
    private void initComponents() {
        ...
        bt_cadastrar.setText("CALCULAR MULTA");
        bt_cadastrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_cadastrarActionPerformed(evt);
            }
        });
        jPanel1.add(bt_cadastrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 180, 30));

        jPanelFundo.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 660, 290));

        bt_cadastrar1.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        bt_cadastrar1.setText("FAZER DEVOLUÇÃO");
        bt_cadastrar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_cadastrar1ActionPerformed(evt);
            }
        });
        jPanelFundo.add(bt_cadastrar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 460, -1, 50));

        getContentPane().add(jPanelFundo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 740, 550));
